...
class EquiposControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipo" do
    assert_difference('Equipo.count') do
      post equipos_url, params: { equipo: { description: @equipo.description, name: @equipo.name, picture: @equipo.picture, price: @equipo.price } }
    end
  ...
  test "should update equipo" do
    patch equipo_url(@equipo), params: { equipo: { description: @equipo.description, name: @equipo.name, picture: @equipo.picture, price: @equipo.price } }
