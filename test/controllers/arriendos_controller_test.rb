...
class ArriendosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create arriendo" do
    assert_difference('Arriendo.count') do
      post arriendos_url, params: { arriendo: { altura: @arriendo.altura, apellidom: @arriendo.apellidom, apellidop: @arriendo.apellidop, cantidad: @arriendo.cantidad, edad: @arriendo.edad, equipo_id: @arriendo.equipo_id, nombre: @arriendo.nombre, nropedido: @arriendo.nropedido, peso: @arriendo.peso, talla: @arriendo.talla, user_id: @arriendo.user_id } }
    end
